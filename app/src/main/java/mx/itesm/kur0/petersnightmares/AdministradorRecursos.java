...
public class AdministradorRecursos
{
    ...
    public void cargarRecursosDodge() {
        ...
        texturaImagenLetras = new BuildableBitmapTextureAtlas(actividadJuego.getTextureManager(),1383,47);
        regionImagenLetras = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(texturaImagenLetras, actividadJuego.getAssets(), "DodgeResponsibility/Letras.png", 26, 1);
        try {
